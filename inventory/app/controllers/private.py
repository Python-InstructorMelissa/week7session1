...
def viewInventory(id):
    ...
    # print("***********front end list: ", Owner.getListWithItems(data))
    return render_template('viewList.html', ownerList=Owner.getOneWithUser(data), user=User.getAll(), inventory=Owner.getListWithItems(data), items=Inventory.getAll())
